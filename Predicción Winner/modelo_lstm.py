...
Original file is located at
    https://colab.research.google.com/drive/1HmfXfmHB3aBsJmfqKrpyty7bZ4Xje-05
...
from keras.src.layers import Masking, LSTM, Dense, LeakyReLU, Dropout
...
# Las columnas categóricas se llenan con 'missing'

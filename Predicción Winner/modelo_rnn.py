...
Original file is located at
    https://colab.research.google.com/drive/1MTAgK6CnBYg1XueAYQId9KwuI-X8Oa0F
...
from keras.src.layers import Masking, SimpleRNN, Dense, LeakyReLU, Dropout
...
# Guardar a CSV
history_df.to_csv("training_history_rnn.csv", index=False)

print("Historial de entrenamiento guardado como 'training_history_rnn.csv'")
